...
m.prototype.debug=function(a){return this.getSolver(!0)(a)};m.prototype.debugFormatter=function(a){return a.set("topoNames",this.topoNames)};m.prototype.getSolver=function(a){var b=this;a=void 0===a?!1:a;var d=z(this.getIdG()),c=this.topo.filter(function(a){return d.has(a.id)}),e=c.map(x),f=c.map(function(a){return a.clean()}),h=this._rootNode.id,k=new Map;k.set("topoIds",e);return function(d){k.set("data",d);d=f.reduce(function(a,b){return b.solve(a)},k);return a?b.debugFormatter(d):d.get(h)}};m.prototype.dump=
function(){return JSON.stringify({M:[this.description,this.units,this.ref],G:[].concat($jscomp.arrayFromIterable(this.getIdG())).map(function(a){var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;return[a,[].concat($jscomp.arrayFromIterable(b))]}),N:this.topo.map(function(a){return a.dump()})})};m.read=function(a){var b=u(a);if(b)try{var c=b.N.map(function(a){return new l(-1,void 0,a)}),d=function(a){return function(b){return b.id===a}},e=new Map(b.G),f=new m;f.G=new Map;for(var h=$jscomp.makeIterator(e.keys()),
k=h.next();!k.done;k=h.next())f.addNode(c.find(d(k.value)));f._rootNode=f.nodes[0];a={};for(var p=$jscomp.makeIterator(e.entries()),n=p.next();!n.done;a={node:a.node},n=p.next()){var q=$jscomp.makeIterator(n.value),r=q.next().value,t=q.next().value;a.node=c.find(d(r));t.forEach(function(a){return function(b){b=c.find(d(b));f.connect(a.node,b)}}(a))}f.nodes.forEach(function(a){a.setAllArgs(b.N.find(function(b){return b.I===a.id}).A)});f.description=b.M?b.M[0]||"":"";f.units=b.M?b.M[1]||"":"";f.ref=
b.M?b.M[2]:null;return f}catch(M){console.log(M)}};$jscomp.global.Object.defineProperties(m.prototype,{meta:{configurable:!0,enumerable:!0,get:function(){return this._meta},set:function(a){this._meta=a}},description:{configurable:!0,enumerable:!0,get:function(){return this._description},set:function(a){this._description=f(a)?a:this._description}},units:{configurable:!0,enumerable:!0,get:function(){return this._units},set:function(a){this._units=f(a)?a:this._units}},ref:{configurable:!0,enumerable:!0,
get:function(){return this._ref},set:function(a){this._ref=e(a)?a:null}},root:{configurable:!0,enumerable:!0,get:function(){return this._rootNode}},nodes:{configurable:!0,enumerable:!0,get:function(){return[].concat($jscomp.arrayFromIterable(this.G.keys()))}},graph:{configurable:!0,enumerable:!0,get:function(){return this.G}},topo:{configurable:!0,enumerable:!0,get:function(){return L(this.G)}},leafs:{configurable:!0,enumerable:!0,get:function(){return y(this.G).Q}},orphans:{configurable:!0,enumerable:!0,
get:function(){for(var a=[],b=$jscomp.makeIterator(this.G.entries()),c=b.next();!c.done;c=b.next()){c=$jscomp.makeIterator(c.value);var e=c.next().value;0===c.next().value.size&&e!==this._rootNode&&a.push(e)}return a}},names:{configurable:!0,enumerable:!0,get:function(){return this.nodes.map(function(a){return a.name})}},topoNames:{configurable:!0,enumerable:!0,get:function(){return this.topo.map(function(a){return a.name})}},ids:{configurable:!0,enumerable:!0,get:function(){return this.nodes.map(function(a){return a.id})}},
topoIds:{configurable:!0,enumerable:!0,get:function(){return this.topo.map(function(a){return a.id})}}});return m}();
