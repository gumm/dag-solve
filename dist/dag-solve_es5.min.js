...
$jscomp.checkEs6ConformanceViaProxy=function(){try{var a={},c=Object.create(new $jscomp.global.Proxy(a,{get:function(d,e,f){return d==a&&"q"==e&&f==c}}));return!0===c.q}catch(d){return!1}};$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS=!1;$jscomp.ES6_CONFORMANCE=$jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS&&$jscomp.checkEs6ConformanceViaProxy();$jscomp.owns=function(a,c){return Object.prototype.hasOwnProperty.call(a,c)};
$jscomp.polyfill=function(a,c,d,e){if(c){d=$jscomp.global;a=a.split(".");for(e=0;e<a.length-1;e++){var f=a[e];f in d||(d[f]={});d=d[f]}a=a[a.length-1];e=d[a];c=c(e);c!=e&&null!=c&&$jscomp.defineProperty(d,a,{configurable:!0,writable:!0,value:c})}};
$jscomp.polyfill("WeakMap",function(a){function c(){if(!a||!Object.seal)return!1;try{var c=Object.seal({}),e=Object.seal({}),d=new a([[c,2],[e,3]]);if(2!=d.get(c)||3!=d.get(e))return!1;d.delete(c);d.set(e,4);return!d.has(c)&&4==d.get(e)}catch(t){return!1}}function d(a){$jscomp.owns(a,f)||$jscomp.defineProperty(a,f,{value:{}})}function e(a){var c=Object[a];c&&(Object[a]=function(a){d(a);return c(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(c())return a;
var f="$jscomp_hidden_"+Math.random();e("freeze");e("preventExtensions");e("seal");var h=0,l=function(a){this.id_=(h+=Math.random()+1).toString();if(a){$jscomp.initSymbol();$jscomp.initSymbolIterator();a=$jscomp.makeIterator(a);for(var c;!(c=a.next()).done;)c=c.value,this.set(c[0],c[1])}};l.prototype.set=function(a,c){d(a);if(!$jscomp.owns(a,f))throw Error("WeakMap key fail: "+a);a[f][this.id_]=c;return this};l.prototype.get=function(a){return $jscomp.owns(a,f)?a[f][this.id_]:void 0};l.prototype.has=
...
$jscomp.polyfill("Map",function(a){function c(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var c=Object.seal({x:4}),d=new a($jscomp.makeIterator([[c,"s"]]));if("s"!=d.get(c)||1!=d.size||d.get({x:4})||d.set({x:4},"t")!=d||2!=d.size)return!1;var e=d.entries(),f=e.next();if(f.done||f.value[0]!=c||"s"!=f.value[1])return!1;f=e.next();return f.done||4!=f.value[0].x||"t"!=f.value[1]||!e.next().done?!1:!0}catch(w){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(c())return a;$jscomp.initSymbol();$jscomp.initSymbolIterator();var d=new WeakMap,e=function(a){this.data_={};this.head_=l();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var c;!(c=a.next()).done;)c=c.value,this.set(c[0],c[1])}};e.prototype.set=function(a,c){var d=f(this,a);d.list||(d.list=this.data_[d.id]=[]);d.entry?d.entry.value=c:(d.entry={next:this.head_,previous:this.head_.previous,head:this.head_,
key:a,value:c},d.list.push(d.entry),this.head_.previous.next=d.entry,this.head_.previous=d.entry,this.size++);return this};e.prototype.delete=function(a){a=f(this,a);return a.entry&&a.list?(a.list.splice(a.index,1),a.list.length||delete this.data_[a.id],a.entry.previous.next=a.entry.next,a.entry.next.previous=a.entry.previous,a.entry.head=null,this.size--,!0):!1};e.prototype.clear=function(){this.data_={};this.head_=this.head_.previous=l();this.size=0};e.prototype.has=function(a){return!!f(this,a).entry};
e.prototype.get=function(a){return(a=f(this,a).entry)&&a.value};e.prototype.entries=function(){return h(this,function(a){return[a.key,a.value]})};e.prototype.keys=function(){return h(this,function(a){return a.key})};e.prototype.values=function(){return h(this,function(a){return a.value})};e.prototype.forEach=function(a,c){for(var d=this.entries(),e;!(e=d.next()).done;)e=e.value,a.call(c,e[1],e[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var f=function(a,c){var e=c&&typeof c;"object"==
...
$jscomp.polyfill("Array.prototype.includes",function(a){return a?a:function(a,d){var c=this;c instanceof String&&(c=String(c));var f=c.length;d=d||0;for(0>d&&(d=Math.max(d+f,0));d<f;d++){var h=c[d];if(h===a||Object.is(h,a))return!0}return!1}},"es7","es3");
$jscomp.checkStringArgs=function(a,c,d){if(null==a)throw new TypeError("The 'this' value for String.prototype."+d+" must not be null or undefined");if(c instanceof RegExp)throw new TypeError("First argument to String.prototype."+d+" must not be a regular expression");return a+""};$jscomp.polyfill("String.prototype.includes",function(a){return a?a:function(a,d){return-1!==$jscomp.checkStringArgs(this,a,"includes").indexOf(a,d||0)}},"es6","es3");
$jscomp.findInternal=function(a,c,d){a instanceof String&&(a=String(a));for(var e=a.length,f=0;f<e;f++){var h=a[f];if(c.call(d,h,f,a))return{i:f,v:h}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,d){return $jscomp.findInternal(this,a,d).v}},"es6","es3");$jscomp.polyfill("Array.prototype.keys",function(a){return a?a:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
...
var Dag=function(){function a(b){var g;return $jscomp.generator.createGenerator(a,function(a){switch(a.nextAddress){case 1:g=b?b+1:0;case 2:return a.yield(g++,2)}})}var c=function(b){for(var a=0;a<arguments.length;++a);},d=function(b){for(var a=0;a<arguments.length;++a);return!1};(new Map).set("true",!0).set("false",!1);var e=function(b){return void 0!==b},f=function(b){return"string"===typeof b},h=function(b){return"number"===typeof b&&!Number.isNaN(b)},l=function(b,a){return b.length===a.length&&
b.every(function(b,g){return a[g]===b})},q=function(b,a){return function(g){g=a.reduce(function(b,a){try{return b[a]}catch(x){}},g);return void 0===g?b:g}},v=function(b){var a=Math.pow(10,b);return function(b){return Math.round(b*a)/a}},p=function(b){return f(b)&&!Number.isNaN(t(b))},t=function(b){return parseInt(b.split("$").join(""),10)-1},F=function(b,a){return b.filter(function(b){return b[0]!==a})},w=function(b){try{var a=JSON.parse(b)}catch(X){}return a},G=new Map([["!=",function(b,a){return b!=
a}],["==",function(b,a){return b==a}],["!==",function(b,a){return b!==a}],["===",function(b,a){return b===a}],["<=",function(b,a){return b<=a}],[">=",function(b,a){return b>=a}],["<",function(b,a){return b<a}],[">",function(b,a){return b>a}]]),y=new Map([["vu",function(b,a,c){return b?a:void 0}],["10",function(b,a,c){return b?1:0}],["tf",function(b,a,c){return b}],["ab",function(b,a,c){return b?a:c}]]),H=function(b){var a=[].concat($jscomp.arrayFromIterable("+-*/%()".split("")),$jscomp.arrayFromIterable("0123456789.".split("")),
$jscomp.arrayFromIterable(["$"," ","'"]),$jscomp.arrayFromIterable("& | ^ ~ << >> >>>".split(" ")),$jscomp.arrayFromIterable(["int","len"]));return[].concat($jscomp.arrayFromIterable(b)).filter(function(b){return a.includes(b)}).join("")},z=function(b){try{return[null,new Function("X",['const len = e => ("" + e).length;const int = e => parseInt(e, 10);',"try {return "+b+";}catch(e){return;}"].join(""))]}catch(g){return['Could not make a function with "'+b+'"',c]}},I=function(b,a){var g="Unable to clean math",
d=c;f(b)?(b=a.reduce(function(b,a,g){return b.split("$"+(g+1)).join("X.get("+a+")")},H(b)),b.includes("$")||(d=$jscomp.makeIterator(z(b)),g=d.next().value,d=d.next().value)):(d=$jscomp.makeIterator(z(b)),g=d.next().value,d=d.next().value);return[g,d]},J=function(b,a){b=b.map(function(b){b=$jscomp.makeIterator(b);var g=b.next().value,c=b.next().value;if(f(c)&&p(c)){var d=t(c);return[g,function(b){return b.get(a[d])}]}return[g,function(){return c}]});var g=new Map(b);return[null,function(b){var c=g.get(b.get(a[0]));
return c?c(b):void 0}]},K=function(b,a){var g=v(b);return[null,function(b){return g(b.get(a[0]))}]},r=function(b,a){if(f(b)){var g=t(b);var c=function(b){return b.get(a[g])}}else c=function(){return b};return c},L=function(b,a){var g=$jscomp.makeIterator(b);b=g.next().value;var e=g.next().value,f=g.next().value;g=g.next().value;var x=r(b,a),h=r(f,a),k=G.get(e)||d,u=y.get(g)||c;return[null,function(b){var a=$jscomp.makeIterator([x(b),h(b)]);b=a.next().value;a=a.next().value;return u(k(b,a),b,a)}]},
M=function(b,a){var g=$jscomp.makeIterator(b);b=g.next().value;var d=g.next().value,e=g.next().value;g=g.next().value;var f=r(b,a),h=r(d,a),k=r(e,a),u=y.get(g)||c;return[null,function(b){var a=$jscomp.makeIterator([f(b),h(b),k(b)]);b=a.next().value;var g=a.next().value;a=a.next().value;a=$jscomp.makeIterator([Math.min(g,a),Math.max(g,a)]);g=a.next().value;a=a.next().value;return b>=g&&b<=a?u(!0,b,g):b>=g?u(!1,b,a):u(!1,b,g)}]},N=function(b,a){return[null,l(b,[null])?function(b){return b.get(a.length?
a[0]:"data")}:function(g){return q(void 0,b)(g.get(a.length?a[0]:"data"))}]},O=function(b,a){a=$jscomp.makeIterator(b);b=a.next().value;a=a.next().value;var g=["_ev",b.toString(),a];return[null,function(a){return q(void 0,g)(a.get("data"))}]},A=function(a,g){return[null,function(){return a}]},P=(new Map).set("Math",function(a){return e(a.math)}).set("Enumerator",function(a){return a.enum&&a.enum.length}).set("Rounding",function(a){return e(a.round)}).set("Comparator",function(a){return a.comparator&&
a.comparator.length}).set("Range",function(a){return a.between&&a.between.length}).set("Data Access",function(a){return a.path&&a.path.length}).set("Event Access",function(a){return a.evCode&&2===a.evCode.length}).set("Constant",function(a){return e(a.fallback)}),Q=(new Map).set("Math",function(a){return I(a.math,a.args)}).set("Enumerator",function(a){return J(a.enum,a.args)}).set("Rounding",function(a){return K(a.round,a.args)}).set("Comparator",function(a){return L(a.comparator,a.args)}).set("Range",
function(a){return M(a.between,a.args)}).set("Data Access",function(a){return N(a.path,a.args)}).set("Event Access",function(a){return O(a.evCode,a.args)}).set("Constant",function(a){return A(a.fallback,a.args)}).set(void 0,function(a){return A(a.fallback,a.args)}),R=(new Map).set("Math",function(a){return a.math}).set("Enumerator",function(a){return a.enum.map(function(a){var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;return"{"+a+" \ud83e\udc1a "+b+"}"}).join("|")}).set("Rounding",
function(a){return a.round}).set("Comparator",function(a){return a.comparator.join(" ").replace(/([<>])/gi,String.raw($jscomp$templatelit$0))}).set("Range",function(a){return a.between.join(" ")}).set("Data Access",function(a){return a.path.join(" ")}).set("Event Access",function(a){return a.evCode.join(" ")}).set("Constant",function(a){return a.fallback}).set(void 0,function(a){return"Not Configured"}),k=function(a,g,d){var b=this;this._id=a;this._name=g;this._args=[];this._math=void 0;this._enum=
...
"Not init"};k.prototype.addArg=function(a){this._args.push(a._id);this._nodus="Args added";return this};k.prototype.delArg=function(a){this._args=this._args.filter(function(b){return b!==a._id});this._nodus="Args removed";return this};k.prototype.setAllArgs=function(a){Array.isArray(a)&&a.every(h)&&(this._args=a)};k.prototype.setFallback=function(a){this._fallback=a;return this};k.prototype.setEvCode=function(a,g){if(e(a)){this._clearAll();var b="data";g&&(g=g.toLowerCase(),b=["data","desc","code"].includes(g)?
...
function(a,g,c,d){var b=!0;b=(h(a)||p(a))&&b;b=(h(c)||p(c))&&b;b="!= !== == === <= >= < >".split(" ").includes(g)&&b;if(b=["vu","10","tf","ab"].includes(d)&&b)this._clearAll(),this._comparator=[a,g,c,d];return this};k.prototype.setBetween=function(a,g,c,d){var b=!0;b=(h(a)||p(a))&&b;b=(h(g)||p(g))&&b;b=(h(c)||p(c))&&b;if(b=["vu","10","tf","ab"].includes(d)&&b)this._clearAll(),this._between=[a,g,c,d];return this};k.prototype.addEnum=function(a,c){if(void 0===a)return this;this._clearAll(!1);this._enum=
[].concat($jscomp.arrayFromIterable((new Map(this._enum)).set(a,c).entries()));return this};k.prototype.delEnum=function(a){this._enum=F(this._enum,a);this._nodus="Changed";return this};k.prototype.clean=function(){var a=$jscomp.makeIterator(Q.get(this.type)(this)),c=a.next().value;a=a.next().value;this._nodus=c;this._func=a;return this};k.prototype.solve=function(a){if(this._nodus)this.clean();else{var b=this._func(a);return a.set(this._id,void 0===b?this.fallback:b)}return this._nodus?(a.set(this._id,
void 0),a.set("err_"+this._id,!this._nodus),a):this.solve(a)};k.isIn=function(a){return function(b,c){c=$jscomp.makeIterator(c);var d=c.next().value;return c.next().value.has(a)?b.push(d)&&b:b}};$jscomp.global.Object.defineProperties(k.prototype,{id:{configurable:!0,enumerable:!0,get:function(){return this._id}},descr:{configurable:!0,enumerable:!0,get:function(){return R.get(this.type)(this)}},name:{configurable:!0,enumerable:!0,get:function(){return this._name},set:function(a){this._name=a}},type:{configurable:!0,
...
[])};m.prototype.outdegrees=function(a){return n(a)?[].concat($jscomp.arrayFromIterable(this.G.get(a))):!1};m.prototype.getIdG=function(){return[].concat($jscomp.arrayFromIterable(this.G)).reduce(function(a,c){var b=$jscomp.makeIterator(c);c=b.next().value;b=b.next().value;return a.set(c.id,new Set([].concat($jscomp.arrayFromIterable(b)).map(B)))},new Map)};m.prototype.solve=function(a){return this.getSolver()(a)};m.prototype.debug=function(a){return this.getSolver(!0)(a)};m.prototype.debugFormatter=
function(a){return a.set("topoNames",this.topoNames)};m.prototype.getSolver=function(a){var b=this;a=void 0===a?!1:a;var c=D(this.getIdG()),d=this.topo.filter(function(a){return c.has(a.id)}),e=d.map(B),f=d.map(function(a){return a.clean()}),h=this._rootNode.id,k=new Map;k.set("topoIds",e);return function(c){k.set("data",c);c=f.reduce(function(a,b){return b.solve(a)},k);return a?b.debugFormatter(c):c.get(h)}};m.prototype.dump=function(){return JSON.stringify({M:[this.description,this.units,this.ref],
G:[].concat($jscomp.arrayFromIterable(this.getIdG())).map(function(a){var b=$jscomp.makeIterator(a);a=b.next().value;b=b.next().value;return[a,[].concat($jscomp.arrayFromIterable(b))]}),N:this.topo.map(function(a){return a.dump()})})};m.prototype.dotPlot=function(a){a=e(a)?this.debug(a):void 0;return U(this,a)};m.read=function(a){var b=w(a);if(b)try{var c=b.N.map(function(a){return new k(-1,void 0,a)}),d=function(a){return function(b){return b.id===a}},e=new Map(b.G),f=new m;f.G=new Map;for(var h=
$jscomp.makeIterator(e.keys()),l=h.next();!l.done;l=h.next())f.addNode(c.find(d(l.value)));f._rootNode=f.nodes[0];a={};for(var n=$jscomp.makeIterator(e.entries()),p=n.next();!p.done;a={node:a.node},p=n.next()){var q=$jscomp.makeIterator(p.value),r=q.next().value,t=q.next().value;a.node=c.find(d(r));t.forEach(function(a){return function(b){b=c.find(d(b));f.connect(a.node,b)}}(a))}f.nodes.forEach(function(a){a.setAllArgs(b.N.find(function(b){return b.I===a.id}).A)});f.description=b.M?b.M[0]||"":"";
f.units=b.M?b.M[1]||"":"";f.ref=b.M?b.M[2]:null;return f}catch(W){console.log(W)}};$jscomp.global.Object.defineProperties(m.prototype,{meta:{configurable:!0,enumerable:!0,get:function(){return this._meta},set:function(a){this._meta=a}},description:{configurable:!0,enumerable:!0,get:function(){return this._description},set:function(a){this._description=f(a)?a:this._description}},units:{configurable:!0,enumerable:!0,get:function(){return this._units},set:function(a){this._units=f(a)?a:this._units}},
ref:{configurable:!0,enumerable:!0,get:function(){return this._ref},set:function(a){this._ref=e(a)&&(f(a)||h(a))?a:null}},root:{configurable:!0,enumerable:!0,get:function(){return this._rootNode}},nodes:{configurable:!0,enumerable:!0,get:function(){return[].concat($jscomp.arrayFromIterable(this.G.keys()))}},graph:{configurable:!0,enumerable:!0,get:function(){return this.G}},topo:{configurable:!0,enumerable:!0,get:function(){return V(this.G)}},leafs:{configurable:!0,enumerable:!0,get:function(){return C(this.G).Q}},
